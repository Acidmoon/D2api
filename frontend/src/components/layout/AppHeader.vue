    ...
    <div class="flex h-16 items-center justify-between px-4 md:px-6">
      ...
      <div class="flex items-center gap-3">
        ...
        <div v-if="user" class="relative" ref="dropdownRef">
          ...
          >
            <div class="flex h-8 w-8 items-center justify-center overflow-hidden rounded-xl text-sm font-medium text-white" style="background: var(--nm-accent); color: var(--nm-on-accent)">
              <img
                v-if="avatarUrl"
                :src="avatarUrl"
                :alt="displayName"
