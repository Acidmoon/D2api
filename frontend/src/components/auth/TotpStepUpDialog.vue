<template>
  <div v-if="controller.visible.value" class="fixed inset-0 z-[60] overflow-y-auto">
    <div class="flex min-h-full items-center justify-center p-4">
      ...
      <div class="card relative w-full max-w-md transform rounded-2xl p-6 transition-all">
        <div class="mb-6 text-center">
          <div
            class="mx-auto flex h-12 w-12 items-center justify-center rounded-full"
            style="background: var(--nm-accent-soft)"
          >
            <svg class="h-6 w-6 text-brand" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
        ...
        <div class="mb-6">
          ...
          <div class="flex justify-center gap-2">
            <input
              ...
              pattern="[0-9]"
              autocomplete="off"
              class="h-12 w-10 rounded-xl border border-input bg-card text-center text-lg font-semibold text-foreground transition-colors focus:border-ring focus:outline-none"
              :disabled="verifying"
