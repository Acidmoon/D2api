<template>
  ...
  >
    ...
    >
        ...
        <div class="mb-3 flex items-center justify-between">
          ...
          <button
            ...
            :class="[
              ...
              grokOAuthCustomBaseUrlEnabled ? 'bg-primary' : 'bg-gray-200 dark:bg-dark-600'
            ]"
          >
            <span
              :class="[
      ...
      <div v-if="headerOverrideCapable" class="border-t border-gray-200 pt-4 dark:border-dark-600">
        <div class="mb-3 flex items-center justify-between">
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
              headerOverrideEnabled ? 'bg-primary' : 'bg-gray-200 dark:bg-dark-600'
            ]"
          >
            <span
              :class="[
        ...
        <div>
          <label class="flex items-center gap-2 cursor-pointer">
            <input
              ...
              class="edit-checkbox"
            />
            <span class="edit-option-label">{{ t('admin.accounts.bedrockForceGlobal') }}</span>
          </label>
        ...
        <div class="edit-section">
          ...
          <div v-else class="space-y-3">
            <div v-for="(mapping, index) in modelMappings" :key="getModelMappingKey(mapping)" class="flex items-center gap-2">
              ...
              <button type="button" @click="modelMappings.splice(index, 1)" class="edit-icon-danger">
                <Icon name="trash" size="sm" />
              </button>
            </div>
            <button type="button" @click="modelMappings.push({ from: '', to: '' })" class="edit-add-row-button">
              + {{ t('admin.accounts.addMapping') }}
            </button>
            ...
            <div class="grid grid-cols-1 gap-2 sm:grid-cols-2">
              ...
              >
                ...
                <span class="min-w-0">
                  ...
                  <span class="edit-choice-description">{{ option.description }}</span>
                </span>
              </button>
            </div>
          </div>
        ...
        <div>
          ...
          <div class="grid grid-cols-1 gap-2 sm:grid-cols-2">
            ...
            >
              ...
              />
              <span class="edit-option-label">{{ option.label }}</span>
            </label>
          </div>
      ...
      >
        <div class="flex items-center justify-between">
          ...
          <button
            ...
            :class="[
              'edit-switch',
              anthropicPassthroughEnabled ? 'edit-switch--on' : 'edit-switch--off'
            ]"
          >
            <span
              :class="[
      ...
      >
        <div class="flex items-center justify-between gap-4">
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
              openAILongContextBillingEnabled ? 'bg-primary' : 'bg-gray-200 dark:bg-dark-600'
            ]"
          >
            <span
              :class="[
      ...
      >
        <div class="flex items-center justify-between">
          ...
          <button
            ...
            :class="[
              'edit-switch',
              codexCLIOnlyEnabled ? 'edit-switch--on' : 'edit-switch--off'
            ]"
          >
            <span
              :class="[
        ...
        >
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
              codexCLIOnlyAppServerEnabled ? 'bg-primary' : 'bg-gray-200 dark:bg-dark-600'
            ]"
          >
            <span
              :class="[
        ...
        <div>
          ...
          <div v-if="openAICompactModelMappings.length > 0" class="mb-3 space-y-2">
            ...
            >
              ...
              />
              <button type="button" @click="removeOpenAICompactModelMapping(index)" class="edit-icon-danger">
                <Icon name="trash" size="sm" />
              </button>
            </div>
          </div>
          <button type="button" @click="addOpenAICompactModelMapping" class="edit-add-row-button">
            + {{ t('admin.accounts.addMapping') }}
          </button>
        </div>
      </div>
      ...
      <div>
        <div class="flex items-center justify-between">
          ...
          <button
            ...
            :class="[
              'edit-switch',
              autoPauseOnExpired ? 'edit-switch--on' : 'edit-switch--off'
            ]"
          >
            <span
              :class="[
        ...
        <div class="space-y-2">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
                autoPause5hDisabled ? 'bg-primary' : 'bg-gray-200 dark:bg-dark-600'
              ]"
        ...
        <div class="space-y-2">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
                autoPause7dDisabled ? 'bg-primary' : 'bg-gray-200 dark:bg-dark-600'
              ]"
        ...
        <div class="rounded-lg border border-gray-200 p-4 dark:border-dark-600">
          <div class="mb-3 flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
                windowCostEnabled ? 'bg-primary' : 'bg-gray-200 dark:bg-dark-600'
              ]"
            >
              <span
                :class="[
        ...
        <div class="rounded-lg border border-gray-200 p-4 dark:border-dark-600">
          <div class="mb-3 flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
                sessionLimitEnabled ? 'bg-primary' : 'bg-gray-200 dark:bg-dark-600'
              ]"
            >
              <span
                :class="[
        ...
        <div class="rounded-lg border border-gray-200 p-4 dark:border-dark-600">
          <div class="mb-3 flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
                rpmLimitEnabled ? 'bg-primary' : 'bg-gray-200 dark:bg-dark-600'
              ]"
            >
              <span
                :class="[
        ...
        <div class="rounded-lg border border-gray-200 p-4 dark:border-dark-600">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
                sessionIdMaskingEnabled ? 'bg-primary' : 'bg-gray-200 dark:bg-dark-600'
              ]"
            >
              <span
                :class="[
        ...
        <div class="rounded-lg border border-gray-200 p-4 dark:border-dark-600">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
                cacheTTLOverrideEnabled ? 'bg-primary' : 'bg-gray-200 dark:bg-dark-600'
              ]"
            >
              <span
                :class="[
        ...
        <div class="rounded-lg border border-gray-200 p-4 dark:border-dark-600">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
                customBaseUrlEnabled ? 'bg-primary' : 'bg-gray-200 dark:bg-dark-600'
              ]"
            >
              <span
                :class="[
      ...
      <!-- TLS Fingerprint (Anthropic OAuth/SetupToken 与 OpenAI OAuth 账号) -->
      <div
        v-if="showTLSFingerprintSection"
        class="border-t border-gray-200 pt-4 dark:border-dark-600"
      >
        <div class="rounded-lg border border-gray-200 p-4 dark:border-dark-600">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
                tlsFingerprintEnabled ? 'bg-primary' : 'bg-gray-200 dark:bg-dark-600'
              ]"
            >
              <span
                :class="[
...
// TLS 指纹模拟支持 Anthropic OAuth/SetupToken 与 OpenAI OAuth 账号
const showTLSFingerprintSection = computed(() => {
...
const codexImageToolBadgeClass = computed(() => {
  switch (codexImageToolMode.value) {
    case 'enabled':
      return 'edit-status-badge--success'
    case 'disabled':
      return 'bg-amber-100 text-amber-700 dark:bg-amber-900/40 dark:text-amber-300'
    case 'block':
      return 'bg-rose-100 text-rose-700 dark:bg-rose-900/40 dark:text-rose-300'
    default:
      return 'edit-status-badge--neutral'
  }
})
...
function loadQuotaControlSettings(account: Account) {
  ...
  // TLS fingerprint：Anthropic OAuth/SetupToken 与 OpenAI OAuth 账号支持
...
const handleSubmit = async () => {
  ...
  try {
    ...
    // TLS fingerprint setting (Anthropic OAuth/SetupToken 与 OpenAI OAuth 账号)
    if (showTLSFingerprintSection.value) {
...
.edit-status-badge--neutral {
  background: var(--nm-surface-soft);
  color: var(--nm-ink-muted);
}

.edit-status-badge--success {
  border-color: color-mix(in srgb, var(--nm-success) 34%, var(--nm-border));
  background: var(--nm-success-soft);
  color: var(--nm-success-text);
}

.edit-status-badge--danger {
  border-color: color-mix(in srgb, var(--nm-danger) 34%, var(--nm-border));
  background: var(--nm-danger-soft);
  color: var(--nm-danger-text);
}
...
.edit-choice-card:hover {
  border-color: var(--nm-border);
  background: var(--nm-surface);
  color: var(--nm-ink);
}

.edit-choice-card--active {
  border-color: var(--nm-accent);
  background: var(--nm-accent-soft);
  color: var(--nm-accent-text);
}
...
.edit-choice-check--active {
  border-color: var(--nm-accent);
  background: var(--nm-accent);
  color: var(--nm-on-accent);
}

.edit-choice-description {
  margin-top: 0.125rem;
  display: block;
  color: var(--nm-ink-faint);
  font-size: 0.75rem;
