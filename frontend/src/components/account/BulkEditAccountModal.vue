          ...
          <template v-else>
            ...
            <div v-if="modelRestrictionMode === 'whitelist'">
              ...
              <ModelWhitelistSelector
                ...
                :model-options="bulkModelRestrictionOptions"
              />
...
const antigravityBulkWhitelistModels = ['gemini-3.1-flash-image', 'gemini-2.5-flash-image']
