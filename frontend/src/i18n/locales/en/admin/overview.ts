export default {
    ...
    users: {
      ...
      violationBan: {
        ...
        badge: 'Violation ban (until {until})',
        manualTitle: 'Content-violation temporary ban',
        manualHint: 'A manual ban rejects all API keys of this user immediately and recovers automatically on expiry.',
        duration: 'Ban duration',
        durations: { '10m': '10 minutes', '30m': '30 minutes', '1h': '1 hour', '1d': '1 day', custom: 'Custom' },
        customMinutes: 'Minutes (1-10080)',
        manualBan: 'Ban user',
        banning: 'Banning…',
        invalidDuration: 'Ban duration must be an integer between 1 and 10080 minutes',
        banApplied: 'User temporarily banned',
        banFailed: 'Failed to ban the user',
      },
      editUser: 'Edit User',
      ...
      last7d: 'Last 7d',
      activitySort: 'Active',
      activitySortHint: 'Sort by last 7 days usage (desc → asc → off)',
      sortBy: 'Sort By',
