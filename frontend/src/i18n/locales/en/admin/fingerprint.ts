export default {
  fingerprint: {
    ...
    create: {
      ...
      concurrencyPlaceholder: 'Default 2',
      concurrencyHint: '1–16; out-of-range values are clamped',
      intervalMs: 'Request interval (ms)',
      intervalMsPlaceholder: 'Default 500',
      intervalMsHint: '0–60000; minimum gap between any two probe requests. Use ≥500 for strictly rate-limited accounts like Codex subscriptions',
      submit: 'Start Audit',
      submitting: 'Starting…',
    ...
    references: {
      ...
      delete: 'Delete',
      deleteConfirmTitle: 'Delete Reference',
      deleteConfirmMessage: 'Delete the reference "{model}"? Audits that rely on it can no longer be started.',
      deleted: 'Reference deleted',
      deleteFailed: 'Failed to delete the reference',
    ...
    records: {
      ...
      detail: 'Details',
      delete: 'Delete',
      deleteConfirmTitle: 'Delete Audit Report',
      deleteConfirmMessage: 'Delete the report file of this audit ({id})?',
      deleted: 'Audit record deleted',
      deleteFailed: 'Failed to delete the audit record',
