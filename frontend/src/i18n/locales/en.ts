export default {
  ...
  version: {
    ...
    dockerModeHint: 'When update available, run on server: git pull → docker build → docker compose up -d',
    dockerUpdateGuideTitle: 'Docker Deployment Update Guide',
    dockerUpdateGuide: 'Run the following commands on your server to update:',
    dockerUpdateCmd1: 'git pull origin dev',
    dockerUpdateCmd2: 'docker build -t acidmoon/d2api:dev .',
    dockerUpdateCmd3: 'docker compose up -d',
