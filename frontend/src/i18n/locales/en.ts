export default {
  ...
  keys: {
    ...
    groupRequired: 'Please select at least a primary or secondary group',
  ...
  admin: {
    ...
    groups: {
      ...
      form: {
        ...
        unavailableAlert: 'Unavailable Alert',
        unavailableAlertHint: 'When enabled, if this group has accounts but a real request cannot schedule any account, the system sends an email using the SMTP settings.'
      },
    ...
    subscriptions: {
      ...
      planHint: 'Subscriptions are now user-level billing quota and no longer depend on APC subscription groups.',
      limitHint: 'Leave blank or enter 0 for no limit in that period. Requests consume subscription quota first, then regular balance.',
    ...
    settings: {
      ...
      groupUnavailableAlertNotify: {
        ...
        description: 'Send alerts to these recipients when an enabled group cannot schedule any account for a real request.',
        emails: 'Recipient Emails',
        emailsHint: 'Only non-disabled entries receive email; each group controls whether unavailable alerts are enabled.',
        addEmail: 'Add Email',
        emailPlaceholder: 'Enter email address',
      },
  ...
  version: {
    ...
    dockerModeHint: 'When update available, run on server: docker compose pull && docker compose up -d',
    dockerUpdateGuideTitle: 'Docker Deployment Update Guide',
    dockerUpdateGuide: 'Ensure docker-compose.yml uses ghcr.io/acidmoon/d2api:latest, then run:',
