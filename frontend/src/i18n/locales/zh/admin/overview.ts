export default {
    ...
    users: {
      ...
      violationBan: {
        ...
        clearFailed: '解除封禁失败',
        badge: '违规封禁中（至 {until}）',
        manualTitle: '内容违规临时封禁',
        manualHint: '手动封禁后该用户所有 API Key 立即不可用，到期自动恢复。',
        duration: '封禁时长',
        durations: { '10m': '10 分钟', '30m': '30 分钟', '1h': '1 小时', '1d': '1 天', custom: '自定义' },
        customMinutes: '分钟数（1-10080）',
        manualBan: '手动封禁',
        banning: '封禁中…',
        invalidDuration: '封禁时长需为 1-10080 的整数分钟',
        banApplied: '已临时封禁该用户',
        banFailed: '封禁操作失败',
      },
      editUser: '编辑用户',
      ...
      last7d: '近7天',
      activitySort: '活跃',
      activitySortHint: '按近 7 天用量排序（从多到少 → 从少到多 → 关闭）',
      sortBy: '排序方式',
