export default {
  fingerprint: {
    ...
    create: {
      ...
      advanced: '高级选项',
      concurrency: '并发数',
      concurrencyPlaceholder: '默认 2',
      concurrencyHint: '1–16，超出自动取边界值',
      intervalMs: '请求间隔（毫秒）',
      intervalMsPlaceholder: '默认 500',
      intervalMsHint: '0–60000，任意两个请求的最小发起间隔；Codex 等限流严格的账号建议 ≥500',
      submit: '发起检测',
      submitting: '发起中…',
    ...
    references: {
      ...
      reRegister: '重新注册',
      delete: '删除',
      deleteConfirmTitle: '删除参考基准',
      deleteConfirmMessage: '确定删除参考基准「{model}」吗？删除后使用该参考的检测将无法发起。',
      deleted: '参考已删除',
      deleteFailed: '删除参考失败',
      empty: '暂无参考基准',
    ...
    records: {
      ...
      detail: '详情',
      delete: '删除',
      deleteConfirmTitle: '删除检测报告',
      deleteConfirmMessage: '确定删除这条检测记录（{id}）的报告文件吗？',
      deleted: '检测记录已删除',
      deleteFailed: '删除检测记录失败',
      accountTarget: '账号 #{id}',
      duration: '耗时 {value}'
    },
