  ...
  <AppLayout>
    <div class="space-y-6">
      ...
      >
        ...
        <p class="mt-1 text-muted-foreground">{{ t("admin.plugins.menuNotice") }}</p>
      </div>
      ...
      <div
        ...
        class="flex min-h-56 flex-col items-center justify-center rounded-xl border border-dashed border-border px-6 text-center"
      >
        <Icon name="cube" size="xl" class="text-muted-foreground" />
      ...
      <div v-else class="grid grid-cols-1 gap-4 xl:grid-cols-2">
        ...
        >
          <div
            class="flex flex-wrap items-start justify-between gap-3 border-b border-border/60 p-5"
          >
            <div class="min-w-0">
          ...
          <div class="grid grid-cols-1 gap-x-6 gap-y-4 p-5 md:grid-cols-2">
            ...
            <div>
              ...
              <p
                ...
                class="mt-3 break-words text-xs text-destructive"
              >
                {{ plugin.last_error }}
              </p>
              <p
                v-else-if="plugin.runtime_message"
                class="mt-3 break-words text-xs text-muted-foreground"
              >
            ...
            <div class="md:col-span-2">
              <label
                class="flex items-center justify-between gap-4 text-xs font-medium text-muted-foreground"
              >
          ...
          <div
            class="flex flex-wrap justify-end gap-2 border-t border-border/60 px-5 py-4"
          >
            <button
              type="button"
              class="btn btn-secondary btn-sm"
      ...
      >
        <div
          class="relative min-h-[520px] overflow-hidden rounded-xl bg-muted/50"
        ...
        >
          ...
          >
            ...
            <p class="mt-1 max-w-xl text-sm text-muted-foreground">{{ uiError }}</p>
          </div>
          <iframe
            v-if="uiSession"
            ref="pluginFrame"
