          ...
          <div class="col-span-2 compact-select">
            <div class="relative group">
              <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                <svg
                  class="h-3.5 w-3.5 text-muted-foreground transition-colors group-focus-within:text-brand"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
              ...
              <input
                v-model="q"
                type="text"
                class="input rounded-full py-1.5 pl-9 pr-3 text-xs"
...
.compact-select .select-trigger {
  @apply py-1.5 px-3 text-xs rounded-full;
}
</style>
