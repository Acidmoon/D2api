<template>
  <AppLayout>
    ...
    <div class="page-header">
      ...
      <p class="page-description">{{ t('admin.usage.description') }}</p>
    </div>
    <div class="space-y-6">
      ...
      <div class="card">
        <div class="flex flex-wrap items-center gap-1 px-2 py-2 sm:px-4">
          <button
        ...
        <UsageFilters v-model="filters" ref="usageFiltersRef" flat :mode="activeTab" class="border-b border-border/60" :start-date="startDate" :end-date="endDate" :exporting="exporting" :model-options="modelNameOptions" @change="applyFilters" @refresh="refreshData" @reset="resetFilters" @cleanup="openCleanupDialog" @export="exportToExcel">
