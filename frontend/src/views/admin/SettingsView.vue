  ...
  <AppLayout>
    <div class="mx-auto max-w-6xl space-y-6">
      ...
      <form v-else @submit.prevent="saveSettings" class="space-y-6" novalidate>
        <!-- Tab Navigation -->
        <div
          class="tabs w-fit max-w-full overflow-x-auto"
          role="tablist"
          ...
          <div class="card">
            ...
            <div class="space-y-4 p-6">
              ...
              >
                <div class="flex items-start">
                  <Icon
                    ...
                    size="md"
                    class="mt-0.5 flex-shrink-0 text-semantic-warning"
                  />
                  <p class="ml-3 text-sm text-semantic-warning">
              ...
              <div v-else class="space-y-4">
                <div class="flex items-center justify-between">
                  ...
                  <div class="flex gap-2">
                    ...
                    <button
                      ...
                      :disabled="adminApiKeyOperating"
                      class="btn btn-secondary btn-sm text-semantic-danger hover:text-semantic-danger"
                    >
                ...
                <div
                  v-if="newAdminApiKey"
                  class="space-y-3 rounded-lg border border-border bg-secondary p-4"
                >
                  <p
                    class="text-sm font-medium text-semantic-success"
                  >
                    {{ t("admin.settings.adminApiKey.keyWarning") }}
                  </p>
                  <div class="flex items-center gap-2">
                    <code
                      class="flex-1 select-all break-all rounded border border-border bg-card px-3 py-2 font-mono text-sm"
                    >
                      {{ newAdminApiKey }}
                    </code>
                    <button
                  ...
                  >
                    ...
                    >
                      ...
                      <button
                        ...
                        "
                        class="btn btn-ghost btn-xs text-semantic-danger hover:text-semantic-danger"
                      >
                        <svg
                          class="h-4 w-4"
                          fill="none"
              ...
              <template v-else>
                ...
                >
                  <div class="mb-3 flex items-center gap-2">
                    ...
                    <span
                      class="rounded bg-secondary px-2 py-0.5 text-xs text-muted-foreground"
                    >
                      {{ rule.beta_token }}
                    </span>
                  </div>
                  ...
                  <div v-if="betaPresets[rule.beta_token]?.length" class="mt-3">
                    ...
                    <div class="flex flex-wrap gap-2">
                      <button
                        ...
                        :key="preset.label"
                        type="button"
                        class="inline-flex items-center gap-1 rounded-md border border-brand accent-soft px-2.5 py-1 text-xs font-medium text-brand transition-colors hover:bg-secondary"
                  ...
                  <div class="mt-3">
                    ...
                    >
                      ...
                      <button
                        ...
                        class="shrink-0 rounded p-1 text-semantic-danger transition-colors hover:bg-secondary hover:text-semantic-danger"
                      >
                        <svg
                          class="h-4 w-4"
                          fill="none"
                    ...
                    <div class="flex flex-wrap items-center gap-1.5">
                      ...
                      <button
                        ...
                        :key="pattern"
                        type="button"
                        class="rounded border border-border px-2 py-0.5 text-xs text-muted-foreground transition-colors hover:border-brand hover:bg-secondary hover:text-brand"
              ...
              >
                <div class="mb-3 flex items-center justify-between">
                  ...
                  <button
                    ...
                    class="rounded p-1 text-semantic-danger transition-colors hover:bg-secondary hover:text-semantic-danger"
                ...
                <div
                  class="mb-4 flex flex-wrap items-center gap-x-2 gap-y-1 text-xs text-muted-foreground"
                ...
                >
                  ...
                  <span
                    class="inline-flex items-center rounded accent-soft px-2 py-0.5 font-medium text-brand"
                  >
                  ...
                  <template v-if="hasOpenAIFastPolicyTargetModels(rule)">
                    ...
                    <span aria-hidden="true">→</span>
                    <span
                      class="inline-flex items-center rounded bg-secondary px-2 py-0.5 font-medium text-foreground"
                    >
                      {{
                ...
                >
                  <div class="flex flex-wrap items-center gap-2">
                    <span
                      ...
                      :key="suffix"
                      class="inline-flex items-center gap-1 rounded bg-secondary px-2 py-1 text-xs font-mono text-foreground"
                    >
                      <span>{{ suffix }}</span>
                      <button
                        type="button"
                        class="rounded-full text-muted-foreground hover:bg-secondary hover:text-foreground"
                        @click="
              ...
              >
                <div>
                  ...
                  <p
                    ...
                    class="mt-2 text-sm text-semantic-warning"
                  >
                ...
                >
                  <div class="flex items-start">
                    <Icon
                      name="infoCircle"
                      size="md"
                      class="mt-0.5 flex-shrink-0 text-semantic-info"
                    />
                    <p class="ml-3 text-sm text-semantic-info">
            ...
            <div class="space-y-5 p-6">
              ...
              >
                ...
                <div class="mb-6">
                  ...
                  <div
                    class="grid grid-cols-3 gap-2 rounded-lg bg-secondary p-1"
                  >
                    <button
                      type="button"
                      data-testid="captcha-provider-turnstile"
                      class="inline-flex items-center justify-center gap-2 rounded-md px-3 py-2 text-sm font-medium transition"
                      :class="captchaProviderSelection === 'turnstile' ? 'bg-card text-brand shadow-sm ' : 'text-muted-foreground hover:text-foreground '"
                    ...
                    <button
                      ...
                      class="inline-flex items-center justify-center gap-2 rounded-md px-3 py-2 text-sm font-medium transition"
                      :class="captchaProviderSelection === 'tencent' ? 'bg-card text-brand shadow-sm ' : 'text-muted-foreground hover:text-foreground '"
                    ...
                    <button
                      ...
                      class="inline-flex items-center justify-center gap-2 rounded-md px-3 py-2 text-sm font-medium transition"
                      :class="captchaProviderSelection === 'aliyun' ? 'bg-card text-brand shadow-sm ' : 'text-muted-foreground hover:text-foreground '"
                ...
                <div v-else-if="captchaProviderSelection === 'tencent'">
                  <div class="mb-6 max-w-sm">
                    ...
                    <div class="grid grid-cols-2 gap-2 rounded-lg bg-secondary p-1">
                      <button
                        type="button"
                        ...
                        :class="form.tencent_captcha_region !== 'intl' ? 'bg-card text-brand shadow-sm ' : 'text-muted-foreground hover:text-foreground '"
                ...
                <div v-else class="grid grid-cols-1 gap-6">
                  <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    <div>
                      ...
                      <div
                        class="grid grid-cols-2 gap-2 rounded-lg bg-secondary p-1"
                      >
                        <button
                          type="button"
                          class="inline-flex items-center justify-center rounded-md px-3 py-1.5 text-sm font-medium transition"
                          :class="form.aliyun_captcha_region !== 'sgp' ? 'bg-card text-brand shadow-sm ' : 'text-muted-foreground hover:text-foreground '"
                  ...
                  <div>
                    ...
                    >
                      ...
                      <code
                        ...
                        class="select-all break-all rounded bg-secondary px-2 py-1 font-mono text-xs text-muted-foreground"
                      >
            ...
            <div class="space-y-5 p-6">
              ...
              >
                ...
                <div
                  ...
                  "
                  class="rounded-lg border border-border bg-secondary px-4 py-3 text-sm text-semantic-warning"
                >
                  {{
                    localText(
                  ...
                  >
                    <div class="flex items-center justify-between">
                      <div>
                        ...
                        <p class="text-xs text-semantic-warning mt-1">
            ...
            <div class="space-y-6 p-6">
                ...
                <div v-else class="space-y-3">
                  ...
                  >
                    ...
                    <div class="flex items-end">
                      <button
                        type="button"
                        class="btn btn-secondary default-sub-delete-btn w-full text-semantic-danger hover:text-semantic-danger"
              ...
              <div class="border-t border-border pt-4">
                <div class="mb-3">
                  ...
                  <p class="mt-0.5 text-xs text-semantic-warning">
                    ...
                    <div v-else class="space-y-3">
                      ...
                      >
                        ...
                        <div class="flex items-end">
                          <button
                            type="button"
                            class="btn btn-secondary w-full text-semantic-danger hover:text-semantic-danger"
                            @click="
        ...
        <div v-show="activeTab === 'gateway'" class="space-y-6">
            ...
            <div class="p-6 space-y-4">
                ...
                <div>
                  ...
                  >
                    ...
                    <button
                      type="button"
                      class="btn btn-secondary btn-sm shrink-0 text-semantic-danger hover:text-semantic-danger"
                  ...
                  <p
                    ...
                    class="mt-2 text-xs text-semantic-warning"
                  >
          ...
          <div class="card" data-testid="ollama-cloud-usage-global-settings">
            ...
            <div class="space-y-5 p-6">
              <div v-if="ollamaCloudUsageLoading" class="flex items-center gap-2 text-muted-foreground">
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-3">
                  ...
                  >
                    <div class="flex items-start justify-between gap-3">
                      ...
                      <span
                        class="rounded bg-secondary px-2 py-0.5 text-[11px] font-medium text-muted-foreground"
                      >
                        %
                      </span>
                    </div>
            ...
            <div class="space-y-5 p-6">
              ...
              <div>
                ...
                <div class="space-y-3">
                  ...
                  >
                    <div
                      :class="[ 'flex flex-wrap items-center justify-between gap-3', block.expanded && 'mb-3', ]"
                    >
                      <div class="min-w-0">
                        <div
                          class="text-sm font-medium text-foreground"
                      ...
                      <div class="flex items-center gap-2">
                        ...
                        <button
                          type="button"
                          class="btn btn-secondary btn-sm px-2 text-semantic-danger hover:text-semantic-danger"
                  ...
                  >
                    <div class="flex items-center gap-3">
                      ...
                      <span
                        ...
                        "
                        class="text-xs text-semantic-success"
                      >
                        {{
                          t(
                    ...
                    <button
                      type="button"
                      class="text-semantic-danger hover:text-semantic-danger text-xs"
                    ...
                    <div class="flex items-center gap-2">
                      ...
                      <div
                        v-if="
                          ...
                          provider.quota_limit > 0
                        "
                        class="flex-1 rounded-full bg-secondary"
                        style="height: 6px"
                      >
                        <div
                          class="h-full rounded-full transition-all"
                          :class="quotaPercentage(provider) > 90 ? 'bg-semantic-danger' : quotaPercentage(provider) > 70 ? 'bg-semantic-warning' : 'bg-semantic-success'"
                          :style="{
                            width:
          ...
          >
            <div
              class="mx-4 w-full max-w-lg rounded-xl border border-border bg-card p-6 shadow-xl"
            >
              <h3
              ...
              <div
                v-if="wsTestResult"
                class="mt-4 max-h-80 overflow-y-auto rounded-lg bg-secondary p-4"
              >
                <p
                ...
                >
                  <a
                    :href="r.url"
                    target="_blank"
                    class="text-sm font-medium text-semantic-info hover:underline"
                    >{{ r.title }}</a
                  >
                  <p class="mt-0.5 text-xs text-muted-foreground">
                    {{ r.snippet }}
        ...
        <div v-show="activeTab === 'general'" class="space-y-6">
          ...
          <div class="card">
            ...
            <div class="space-y-6 p-6">
              <!-- Backend Mode -->
              <div
                class="flex items-center justify-between rounded-lg border border-border bg-secondary p-4"
              >
                <div>
              ...
              <div>
                ...
                <div class="space-y-3">
                  ...
                  >
                    <div class="mb-3 flex items-center justify-between">
                      ...
                      <button
                        type="button"
                        class="rounded p-1 text-semantic-danger hover:bg-secondary hover:text-semantic-danger"
                ...
                <button
                  type="button"
                  class="mt-3 flex w-full items-center justify-center gap-2 rounded-lg border-2 border-dashed border-border px-4 py-2.5 text-sm text-muted-foreground transition-colors hover:border-brand hover:text-brand"
                  @click="addEndpoint"
                >
                  <svg
                    class="h-4 w-4"
              ...
              <div>
                ...
                <!-- iframe CSP Warning -->
                <p class="mt-2 text-xs text-semantic-warning">
          ...
          <div class="card">
            ...
            <div class="space-y-4 p-6">
              ...
              <button
                type="button"
                class="flex w-full items-center justify-center gap-2 rounded-lg border-2 border-dashed border-border py-3 text-sm text-muted-foreground transition-colors hover:border-brand hover:text-brand"
                @click="addMenuItem"
              >
                <svg
                  class="h-4 w-4"
	            ...
	            <div class="space-y-6 p-6">
	              <div class="grid grid-cols-1 gap-5 lg:grid-cols-[minmax(0,1fr)_220px]">
                    ...
                    <button
                      type="button"
                      class="inline-flex items-center justify-center gap-2 rounded-md px-3 py-2 text-sm font-medium transition"
                      :class="form.login_agreement_mode === 'modal' ? 'bg-card text-brand shadow-sm ' : 'text-muted-foreground hover:text-foreground '"
                    ...
                    <button
                      type="button"
                      class="inline-flex items-center justify-center gap-2 rounded-md px-3 py-2 text-sm font-medium transition"
                      :class="form.login_agreement_mode === 'checkbox' ? 'bg-card text-brand shadow-sm ' : 'text-muted-foreground hover:text-foreground '"
                  ...
                  >
                    <div class="mb-3 flex items-center justify-between gap-3">
                      <div class="flex min-w-0 items-center gap-3">
                        <span class="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-md bg-secondary text-foreground">
                          <Icon
                            :name="
                              index === 1
                                ? 'shield'
                      ...
                      <button
                        type="button"
                        class="rounded-md p-2 text-semantic-danger transition hover:bg-secondary hover:text-semantic-danger disabled:cursor-not-allowed disabled:opacity-40"
                        :disabled="
                    ...
                    <div class="grid grid-cols-1 gap-3 lg:grid-cols-2">
                      ...
                      <div>
                        ...
                        <div class="flex overflow-hidden rounded-lg border border-border bg-card focus-within:border-brand focus-within:ring-1 focus-within:ring-ring">
                          <span class="inline-flex flex-shrink-0 items-center border-r border-border bg-secondary px-3 text-sm text-muted-foreground">
                            /legal/
                          </span>
                          <input
                            v-model="doc.id"
          ...
          <div class="space-y-5 p-6">
            ...
            <div v-if="form.channel_monitor_enabled" class="space-y-5">
              <div>
                ...
                <div class="mt-1.5 inline-flex w-full max-w-md rounded-lg border border-border bg-secondary p-1">
                  <button
                    type="button"
                    class="inline-flex flex-1 items-center justify-center gap-2 rounded-md px-3 py-2 text-sm font-medium transition"
                    :class="form.channel_monitor_mode === 'v2' ? 'bg-card text-brand shadow-sm ' : 'text-muted-foreground hover:text-foreground '"
                  ...
                  <button
                    type="button"
                    class="inline-flex flex-1 items-center justify-center gap-2 rounded-md px-3 py-2 text-sm font-medium transition"
                    :class="form.channel_monitor_mode === 'v1' ? 'bg-card text-brand shadow-sm ' : 'text-muted-foreground hover:text-foreground '"
                  ...
                  <table class="min-w-full divide-y divide-border">
                    ...
                    <tbody class="divide-y divide-border bg-card">
                      ...
                      <tr v-for="entry in affiliateState.entries" :key="entry.user_id">
                        ...
                        <td class="px-3 py-2 text-sm text-muted-foreground">{{ entry.username }}</td>
                        <td class="px-3 py-2 text-sm font-mono">
                          {{ entry.aff_code }}
                          <span
                            v-if="entry.aff_code_custom"
                            class="ml-1 inline-block rounded accent-soft px-1.5 py-0.5 text-[10px] font-medium text-brand"
                        ...
                        <td class="px-3 py-2 text-sm">
                          <div class="flex items-center gap-2">
                            ...
                            <button
                              type="button"
                              class="text-semantic-danger hover:underline"
            ...
            <div class="space-y-4">
              <div v-if="affiliateModal.mode === 'add'">
                ...
                <div
                  ...
                  class="flex items-center justify-between rounded-md border border-brand accent-soft px-3 py-2"
                >
                  <div class="text-sm">
                  ...
                  <button
                    type="button"
                    class="text-lg leading-none text-muted-foreground hover:text-semantic-danger"
                ...
                <template v-else>
                  ...
                  >
                    <button
                      ...
                      :key="u.id"
                      type="button"
                      class="w-full px-3 py-1.5 text-left text-sm hover:bg-secondary"
              ...
              <template v-if="form.payment_enabled">
                ...
                <div class="grid grid-cols-1 gap-3 sm:grid-cols-3">
                  ...
                  <div>
                    ...
                    <div
                      class="rounded-lg border border-border bg-secondary px-3 py-2 text-sm text-muted-foreground"
                    >
                      {{
                ...
                <div class="flex flex-wrap items-end gap-4">
                  ...
                  <div>
                    ...
                    <div class="flex items-center gap-2">
                      <button
                        type="button"
                        :class="[ 'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2', form.payment_cancel_rate_limit_enabled ? 'bg-primary' : 'bg-secondary ', ]"
                        @click="
                      ...
                      >
                        <span
                          :class="[ 'pointer-events-none inline-block h-5 w-5 transform rounded-full bg-card shadow ring-0 transition duration-200 ease-in-out', form.payment_cancel_rate_limit_enabled ? 'translate-x-5' : 'translate-x-0', ]"
                        />
                      </button>
                      <Select
                      ...
                      />
                      <span
                        :class="[ 'text-sm whitespace-nowrap', form.payment_cancel_rate_limit_enabled ? 'text-foreground' : 'text-muted-foreground ', ]"
                        >{{
                  ...
                  <div>
                    ...
                    <div class="flex items-center gap-2">
                      <button
                        type="button"
                        :class="[ 'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2', form.payment_alipay_force_qrcode ? 'bg-primary' : 'bg-secondary ', ]"
                        @click="
                      ...
                      >
                        <span
                          :class="[ 'pointer-events-none inline-block h-5 w-5 transform rounded-full bg-card shadow ring-0 transition duration-200 ease-in-out', form.payment_alipay_force_qrcode ? 'translate-x-5' : 'translate-x-0', ]"
                        />
                      </button>
                      <span class="text-sm text-muted-foreground">{{
                  ...
                  <div>
                    ...
                    <div class="flex items-center gap-2">
                      <button
                        type="button"
                        :class="[ 'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2', form.payment_alipay_mobile_precreate_deep_link ? 'bg-primary' : 'bg-secondary ', ]"
                        @click="
                      ...
                      >
                        <span
                          :class="[ 'pointer-events-none inline-block h-5 w-5 transform rounded-full bg-card shadow ring-0 transition duration-200 ease-in-out', form.payment_alipay_mobile_precreate_deep_link ? 'translate-x-5' : 'translate-x-0', ]"
                        />
                      </button>
                      <span class="text-sm text-muted-foreground">{{
                ...
                <div>
                  ...
                  <div class="mt-1.5 flex flex-wrap gap-2">
                    <button
                      ...
                      :class="[ 'rounded-lg border px-3 py-1.5 text-sm font-medium transition-all', isPaymentTypeEnabled(pt.value) ? 'border-brand accent-soft text-brand ' : 'border-border bg-card text-muted-foreground hover:border-border hover:bg-secondary ', ]"
                    >
                      {{ pt.label }}
                    </button>
                  </div>
              ...
              <div class="space-y-2">
                ...
                >
                  ...
                  >
                    ...
                    />
                    <div
                      class="w-9 h-5 bg-secondary peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-card after:border-border after:border after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-primary"
                    ></div>
                  </label>
                  <input
                    v-model="entry.email"
...
const form = reactive<SettingsForm>({
  ...
  // Plugin management feature switch (upstream)
...
async function saveSettings() {
  ...
  try {
    ...
    const payload: UpdateSettingsRequest = {
      ...
      // User Leaderboard feature switch (anonymized)
...
/* Accent-tinted selected pill (token-driven via --nm-accent-soft). */
.accent-soft {
  background-color: var(--nm-accent-soft);
}

/* Hide the scrollbar on the pill tab strip while keeping it scrollable. */
[role='tablist'] {
