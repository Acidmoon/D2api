          ...
          <div class="flex items-center gap-3">
            ...
            <div class="min-w-0 flex-1">
              ...
              <p class="text-xs text-gray-500 dark:text-gray-400">
                ...
                <span> · </span>
                <span class="text-semantic-info">{{ t('usage.cacheHit') }} {{ formatTokens(usageStats?.total_cache_read_tokens || 0) }}</span>
                <span> · </span>
                <span class="text-semantic-warning">{{ t('usage.cacheCreate') }} {{ formatTokens(usageStats?.total_cache_creation_tokens || 0) }}</span>
              </p>
              <p class="text-xs text-gray-400 dark:text-gray-500">
                {{ t('usage.cacheHitRate') }}:
                <template v-if="cacheStats.totalInput > 0">
                  <span class="text-semantic-info">{{ formatTokens(cacheStats.cacheRead) }}</span>
        ...
        <div class="swiss-stat-card">
          <div class="flex items-center gap-3">
            ...
            <div class="min-w-0 flex-1">
              ...
              <p class="text-xl font-bold text-semantic-success">
        ...
        >
          ...
          <template #cell-tokens="{ row }">
            ...
            <div v-else class="flex items-center gap-1.5">
              <div class="space-y-1.5 text-sm">
                ...
                <div class="flex items-center gap-2">
                  ...
                  <div class="inline-flex items-center gap-1">
                    <Icon name="arrowDown" size="sm" class="text-semantic-success" />
                  ...
                  <!-- Output -->
                  <div class="inline-flex items-center gap-1">
                    <Icon name="arrowUp" size="sm" class="text-semantic-info" />
                    <span class="font-medium text-gray-900 dark:text-white">{{
                ...
                >
                  ...
                  <div v-if="row.cache_creation_tokens > 0" class="inline-flex items-center gap-1">
                    <Icon name="edit" size="sm" class="text-semantic-warning" />
                    <span class="font-medium text-semantic-warning">{{
                      formatCacheTokens(row.cache_creation_tokens)
                    }}</span>
                    <span v-if="row.cache_creation_1h_tokens > 0" class="badge badge-warning text-[10px] leading-tight">1h</span>
                    <span v-if="row.cache_ttl_overridden" :title="t('usage.cacheTtlOverriddenHint')" class="badge badge-danger cursor-help text-[10px] leading-tight">R</span>
                  </div>
                </div>
                <div v-if="hasImageOutputTokens(row)" class="flex items-center gap-2">
                  <div class="inline-flex items-center gap-1">
                    ...
                    <span class="font-medium text-gray-900 dark:text-white">{{ row.image_output_tokens.toLocaleString() }}</span>
                  </div>
                </div>
              </div>
              ...
              >
                <div
                  class="flex h-4 w-4 cursor-help items-center justify-center border border-gray-200 bg-gray-50 transition-colors group-hover:border-gray-400 dark:border-dark-600 dark:bg-dark-700"
                >
                  <Icon
                    name="infoCircle"
                    size="xs"
          ...
          <template #cell-cost="{ row }">
            <div class="flex items-center gap-1.5 text-sm">
              <span class="font-medium text-semantic-success">
        ...
        <div class="space-y-1.5">
          ...
          <div>
            ...
            <div v-if="tokenTooltipData && tokenTooltipData.cache_ttl_overridden" class="flex items-center justify-between gap-4">
              ...
              <span class="font-medium text-white">{{ tokenTooltipData.cache_creation_1h_tokens > 0 ? t('usage.cacheTtlOverridden1h') : t('usage.cacheTtlOverridden5m') }}</span>
            </div>
      ...
      >
        <div class="space-y-1.5">
          ...
          <div class="mb-2 border-b border-gray-700 pb-1.5">
            ...
            <template v-if="!tooltipData?.billing_mode || tooltipData.billing_mode === BILLING_MODE_TOKEN">
              <div v-if="tooltipData && tooltipData.input_tokens > 0" class="flex items-center justify-between gap-4">
                ...
                <span class="font-medium text-white">{{ formatTokenPricePerMillion(tooltipData.input_cost, tooltipData.input_tokens) }} {{ t('usage.perMillionTokens') }}</span>
              </div>
              <div v-if="tooltipData && tooltipData.output_cost > 0 && textOutputTokens(tooltipData) > 0" class="flex items-center justify-between gap-4">
                ...
                <span class="font-medium text-white">{{ formatTokenPricePerMillion(tooltipData.output_cost, textOutputTokens(tooltipData)) }} {{ t('usage.perMillionTokens') }}</span>
              </div>
              <div v-if="tooltipData && hasImageOutputTokens(tooltipData)" class="flex items-center justify-between gap-4">
                ...
                <span class="font-medium text-white">{{ formatTokenPricePerMillion(tooltipData.image_output_cost ?? 0, tooltipData.image_output_tokens) }} {{ t('usage.perMillionTokens') }}</span>
              </div>
            </template>
            ...
            <template v-else-if="tooltipData && isImageUsage(tooltipData)">
              ...
              <div class="flex items-center justify-between gap-4">
                ...
                <span class="font-medium text-white">${{ imageUnitPrice(tooltipData).toFixed(6) }}</span>
              </div>
              <div class="flex items-center justify-between gap-4">
          ...
          <div class="flex items-center justify-between gap-6">
            ...
            <span class="font-semibold text-white">{{ getUsageServiceTierLabel(tooltipData?.service_tier, t) }}</span>
          </div>
          <div class="flex items-center justify-between gap-6">
...
const getRequestTypeBadgeClass = (log: UsageLog): string => {
  const requestType = resolveUsageRequestType(log)
  if (requestType === 'ws_v2') return 'badge-primary'
