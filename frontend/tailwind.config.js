...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // Swiss signal accent — one functional color across the app.
        primary: {
          50: '#eef8f6',
          100: '#d9efeb',
          200: '#b7dfd8',
        ...
        // Neutral ink/surface scale for Swiss minimal layouts.
        accent: {
          50: '#f7f7f4',
          100: '#f0f0ec',
          200: '#ddddd6',
        ...
        // Dark surfaces tuned for contrast, not decorative color.
        dark: {
          50: '#f4f4ef',
          100: '#e8e8de',
          200: '#c7c7bd',
