...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	violationCounterCache := repository.NewViolationCounterCache(redisClient)
	concurrencyCache := repository.ProvideConcurrencyCache(redisClient, configConfig)
	schedulerCache := repository.ProvideSchedulerCache(redisClient, configConfig)
	accountRepository := repository.NewAccountRepository(client, db, schedulerCache)
	concurrencyService := service.ProvideConcurrencyService(concurrencyCache, accountRepository, configConfig)
	apiKeyService := service.ProvideAPIKeyService(apiKeyRepository, userRepository, groupRepository, userSubscriptionRepository, userGroupRateRepository, apiKeyCache, configConfig, billingCacheService, concurrencyService, violationCounterCache)
	...
	groupUnavailableAlertService := service.NewGroupUnavailableAlertService(emailService, settingRepository)
	...
	guardEvaluator := accountguard.ProvideGuardEvaluator(openAICompatibleScanner)
	userViolationGuardService := accountguard.NewGuardService(configManager, guardEvaluator, settingRepository, emailService, violationCounterCache)
	gatewayService := service.NewGatewayService(accountRepository, groupRepository, usageLogRepository, usageBillingRepository, userRepository, userSubscriptionRepository, userGroupRateRepository, gatewayCache, configConfig, schedulerSnapshotService, concurrencyService, billingService, rateLimitService, billingCacheService, identityService, httpUpstream, deferredService, claudeTokenProvider, sessionLimitCache, rpmCache, digestSessionStore, settingService, tlsFingerprintProfileService, channelService, modelPricingResolver, compositeRouteResolver, balanceNotifyService, serviceUserPlatformQuotaRepository, userViolationGuardService)
	...
	openAIGatewayService := service.NewOpenAIGatewayService(accountRepository, usageLogRepository, usageBillingRepository, userRepository, userSubscriptionRepository, userGroupRateRepository, gatewayCache, configConfig, schedulerSnapshotService, concurrencyService, billingService, rateLimitService, billingCacheService, httpUpstream, deferredService, openAITokenProvider, grokTokenProvider, modelPricingResolver, channelService, balanceNotifyService, settingService, groupUnavailableAlertService, serviceUserPlatformQuotaRepository, tlsFingerprintProfileService, userViolationGuardService)
	...
	adminUserHandler.SetViolationBanCache(violationCounterCache)
	...
	fingerprintService := service.ProvideFingerprintService(accountService, configConfig)
	fingerprintHandler := admin.NewFingerprintHandler(fingerprintService)
	...
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, grokOAuthHandler, cnProviderHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, userAttributeHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, pluginHandler, adminAPIKeyHandler, scheduledTestHandler, channelHandler, channelMonitorHandler, channelMonitorRequestTemplateHandler, fingerprintHandler, contentModerationHandler, promptAdminHandler, paymentHandler, affiliateHandler, complianceHandler, auditLogHandler, upstreamBillingProbeService, ollamaCloudUsageService)
	...
	imageStudioHistoryRepository := repository.NewImageStudioHistoryRepository(db)
	imageStudioHistoryService := service.ProvideImageStudioHistoryService(imageStudioHistoryRepository, configConfig)
	imageStudioHandler := handler.NewImageStudioHandler(imageStudioHistoryService)
