...
// normalizeDefaultSubscriptionBalances validates independent wallet grants.
// They intentionally do not reference a group: each item snapshots its own
// monthly quota and validity period when assigned.
