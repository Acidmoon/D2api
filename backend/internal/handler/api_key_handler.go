...
type CreateAPIKeyRequest struct {
	...
	PrimaryGroupID *int64   `json:"primary_group_id"` // nullable
...
type UpdateAPIKeyRequest struct {
	...
	PrimaryGroupID dto.NullableInt64Field `json:"primary_group_id"`
...
func (h *APIKeyHandler) Update(c *gin.Context) {
	...
	svcReq.PrimaryGroupID = service.OptionalInt64Field{Set: req.PrimaryGroupID.Set, Value: req.PrimaryGroupID.Value}
	svcReq.GroupID = service.OptionalInt64Field{Set: req.GroupID.Set, Value: req.GroupID.Value}
	if req.Status != "" {
